...
insert into Plant_info (name, ideal_humidity, ideal_temp, conservation_status, taxonomy, visual_description, description) values ('Cyanea st.-johnii (Hosaka) Lammers, Givnish & Systma', 26.99, 20.32, 'Never', 'at nunc commodo placerat praesent blandit nam nulla integer pede', 'et ultrices posuere cubilia curae donec pharetra magna vestibulum aliquet', 'quam sapien varius ut blandit non interdum in ante vestibulum');
...
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (0.12, 16, 'Atriplex wolfii S. Watson', 'Indigo', 16, '16');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (6.89, 8, 'Helianthus nuttallii Torr. & A. Gray ssp.', 'Bluebead', 17, '17');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (5.38, 15, 'Lecidea furva Lowe', 'Aralia', 18, '18');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (6.98, 2, 'Phemeranthus parviflorus (Nutt.) Kiger', 'Blackburd', 19, '19');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (3.43, 10, 'Stellaria alaskana Hultén', 'sultan', 20, '20');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (3.6, 23, 'Claytonia flava A. Nelson', 'Rim Lichen', 21, '21');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (6.2, 14, 'Epilobium siskiyouense (Munz) Hoch & P.H. Raven', 'Thompson''s Pincushion', 22, '22');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (8.03, 19, 'Bacopa egensis (Poepp.) Pennell', 'Purple Rattlesnakeroot', 23, '23');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (7.84, 1, 'Verrucaria calkinsiana Servit', 'Fremont''s Beardtongue', 24, '24');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (1.49, 6, 'Tetraplodon Bruch & Schimp.', 'Hairy Pagoda-plant', 25, '25');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (8.79, 17, 'Diplotomma penichrum (Tuck.) Szat.', 'Fenzl''s False Spleenwort', 26, '26');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (6.06, 2, 'Rhizocarpon intermediellum Rasanen', 'Florida Eccremidium Moss', 27, '27');
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (8.34, 24, 'Archidium alternifolium (Hedw.) Schimp.', 'Carolina Holly', 28, '28');
...
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (6.15, 20, 'Penstemon fruticosus (Pursh) Greene var. fruticosus', 'Old World Adderstongue', 33, '33');
...
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (1.73, 1, 'LCarex ×deamii F.J. Herm.', 'Cutleaf Geranium', 39, '39');
...
insert into Plant (size, age, plant_name, shown_name, plant_id, user_id) values (2.47, 3, 'Boltonia diffusa Elliott var. interior Fernald & Grisc.', 'Belize Sage', 44, '44');
